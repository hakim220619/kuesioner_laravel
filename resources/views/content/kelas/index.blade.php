...
@section('content')
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">List /</span> Kelas</h4>
                                                        ...
                                                        <div class="col mb-4 mt-2">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" id="nameWithTitle"
                                                                    ...
                                                                    value="{{ $a->nama_kelas }}" placeholder="Enter Name">
    ...
    <div class="modal fade" id="addModalKelas" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="addModalKelasTitle">Add Kelas</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('kelas.add') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col mb-4 mt-2">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="nameWithTitle" class="form-control" name="nama_kelas"
                                        placeholder="Enter Name">
                                    <label for="nameWithTitle">Nama Kelas</label>
                                </div>
                            </div>
                        </div>
